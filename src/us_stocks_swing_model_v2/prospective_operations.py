"""Local-only census intake and Git registry readiness preparation."""
...
def build_git_trial_registry_readiness(*, repository_root: Path) -> dict[str, object]:
    """Report local/GitHub registry readiness without writing or networking."""

    return build_git_trial_registry_plan(repository_root)
