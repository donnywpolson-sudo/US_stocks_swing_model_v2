...
if TYPE_CHECKING:
    from .network_execution import NetworkResponseEvidence
...
class NetworkAcquisitionCapability:
    ...
    def __init__(self, *_args: object, **_kwargs: object) -> None:
        raise TypeError(
            "network acquisition capabilities must be issued by the pinned registry"
        )
...
class AsReceivedSnapshotStore:
    ...
    def _land_network_response(
        self,
        *,
        transport_evidence: NetworkResponseEvidence,
        source: str,
        requested_url: str,
        response_url: str,
        http_status: int,
        ...
        from .network_execution import (
            _consume_network_response,
            _validate_network_response,
        )
        ...
        return _consume_network_response(
            transport_evidence,
            **response_contract,
