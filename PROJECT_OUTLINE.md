...
| Alpaca Basic bars | Guarded prospective OHLCV lane; SIP and IEX passed the bounded comparison and SIP is the selected candidate, but no accepted qualification receipt exists and no feed is active |
